...
invaders.current_direction = 'right'
...
function invaders.update_invader( dt, single_invader )
    single_invader.position_x = single_invader.position_x + ((invaders.current_direction=='right') and 1 or -1) * invaders.current_speed_x * dt

    if single_invader.position_x > invaders.right_border_x then invaders.right_border_x = single_invader.position_x end
    if single_invader.position_x < invaders.left_border_x then invaders.left_border_x = single_invader.position_x end
end
...
function invaders.update( dt )
    ...
    if invaders_rows == 0 then
        ...
        if invaders.right_border_x > ( love.graphics.getWidth() - invaders.invader_width ) then 
            invaders.right_border_x = 0
            invaders.current_direction = 'left'
        elseif invaders.left_border_x < 0 then
            invaders.left_border_x = 0
            invaders.current_direction = 'right'
